<template>
  <div class="about">
    <h2>Un nou circuit musical valencià</h2>
    <div class="about-text">
      <p>
        L’Institut Valencià de Cultura presenta Sonora, el nou circuit de la música valenciana, que portarà a la tardor als grups guanyadors i finalistes dels
      ...
      <p>
        ...
        població comparteix enguany amb Altea. El concert va estar protagonitzat per Els Jóvens, grans guanyadors de l’edició 2018 dels premis Carles Santos amb tres guardons:
